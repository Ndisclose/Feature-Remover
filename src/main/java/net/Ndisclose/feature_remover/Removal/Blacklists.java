package net.Ndisclose.feature_remover.Removal;
...
import net.Ndisclose.feature_remover.configuration.ConfigManager;
...
public class Blacklists {
    ...
    private static @Nullable Identifier safeParseIdentifier(String value) {
        try {
            ...
            if (id == null) {
                System.err.println("[Removal Mod] Invalid identifier format: " + value);
            }
            return id;
        } catch (Exception e) {
